...
export class Probando2Component implements OnInit{
  ...
  ngOnInit(): void {
    ...
    //   (data) => {
    //     this.regiones = data;  // Guardamos las regiones en la variable
    //   },
    //   (error) => {
    //     console.error('Error al obtener las regiones:', error);  // Manejo de errores
    //   }
    // );
  ...
  getRegiones(){
    this.regionesService.getRegiones().subscribe((res:any)=>{
